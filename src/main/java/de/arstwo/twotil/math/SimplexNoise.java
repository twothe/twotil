...
public class SimplexNoise {
	 ...
	 *
	 * @param random any Random compatible generator
	 */
	 ...
	 *
	 * @param stretchX how much the x-axis is stretched
	 * @param stretchZ how much the z-axis is stretched
	 * @return a NoiseStretch with the given configuration.
	 */
	 ...
	 *
	 * @param stretchX how much the x-axis is stretched
	 * @param stretchY how much the y-axis is stretched
	 * @param stretchZ how much the z-axis is stretched
	 * @return a NoiseStretch with the given configuration.
	 */
	 ...
	 *
	 * @param xin any double
	 * @param yin any double
	 * @return the noise value at the given 2D position
	 */
	 ...
	 * @param xin any double
	 * @param yin any double
	 * @param zin any double
	 * @return the noise value at the given 3D position
	 */
	 ...
	 * @param z any double
	 * @param w any double
	 * @return the noise value at the given 4D position
	 */
